...
MLX90614는 비접촉 온도 측정을 위한 적외선 온도계입니다. IR 감지 열전퇴 감지기 칩과 신호 조절 ASSP는 모두 동일한 TO-39 캔에 통합되어 있습니다. 저잡음 증폭기, 17비트 ADC 및 강력한 DSP 장치 덕분에 온도계의 높은 정확도와 분해능이 달성됩니다. 온도계는 디지털 PWM 및 SMBus(시스템 관리 버스) 출력으로 공장에서 보정된 상태로 제공됩니다. 표준으로 10비트 PWM은 -20~120˚C 범위에서 측정된 온도를 0.14의 출력 분해능으로 지속적으로 전송하도록 구성됩니다. ˚C. 공장 기본 POR 설정은 SMBus입니다.

LibDriver MLX90614는 LibDriver에서 출시한 MLX90614의 전체 기능 드라이버입니다. 온도 판독, ID 판독 및 기타 기능을 제공합니다. LibDriver는 MISRA를 준수합니다.
...
/src 디렉토리에는 LibDriver MLX90614의 소스 파일이 포함되어 있습니다.

/interface 디렉토리에는 LibDriver MLX90614용 플랫폼 독립적인 IIC버스 템플릿이 포함되어 있습니다.

/test 디렉토리에는 LibDriver MLX90614드라이버 테스트 프로그램이 포함되어 있어 칩의 필요한 기능을 간단히 테스트할 수 있습니다.

/example 디렉토리에는 LibDriver MLX90614프로그래밍 예제가 포함되어 있습니다.

/doc 디렉토리에는 LibDriver MLX90614오프라인 문서가 포함되어 있습니다.

/datasheet 디렉토리에는 MLX90614데이터시트가 있습니다.
...
온라인 문서: [https://www.libdriver.com/docs/mlx90614/index.html](https://www.libdriver.com/docs/mlx90614/index.html).
